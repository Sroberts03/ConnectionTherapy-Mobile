    ...
    return (
        <View>
            ...
            <View className="flex-row items-center my-6">
                ...
                <Text className="text-neutral-400 text-xs mx-4 uppercase tracking-widest">
                    or continue with
                </Text>
                <View className="flex-1 h-px bg-neutral-200" />
            </View>
            ...
            <View className="flex-row gap-3">
                <TouchableOpacity
                    className="flex-1 bg-neutral-100 py-3.5 rounded-2xl items-center border border-neutral-200"
                    activeOpacity={0.7}
